...
----------------------------------------------------------------------------------------
当前版本
IOT平台SDK，SDK_P2P_IOS_V2.7.0_2402291130；RTC_P2P_IOS_V2.0.20_2401251710；OTEL_SDK_IOS_V1.0.1_2401161729
编译时间：2024.02.29
更新内容：1、修复CALL_INFO时OTEL的Trace_id重复问题；2、日志监控系统增加device_type；3、修复快速开关音频流会回调加流成功问题；4、修复退后台切换WiFi时会回调网络变化状态
----------------------------------------------------------------------------------------
